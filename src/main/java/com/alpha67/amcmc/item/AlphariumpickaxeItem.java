...
public class AlphariumpickaxeItem extends AmcmcModElements.ModElement {
	@ObjectHolder("amcmc:alphariumpickaxe")
	public static final Item block = null;

	public AlphariumpickaxeItem(AmcmcModElements instance) {
		super(instance, 5);
	}
