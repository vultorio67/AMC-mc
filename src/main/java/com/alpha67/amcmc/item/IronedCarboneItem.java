...
public class IronedCarboneItem extends AmcmcModElements.ModElement {
	@ObjectHolder("amcmc:ironed_carbone")
	public static final Item block = null;

	public IronedCarboneItem(AmcmcModElements instance) {
		super(instance, 37);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ironed_carbone");
		}
