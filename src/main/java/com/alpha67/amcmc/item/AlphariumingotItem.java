...
public class AlphariumingotItem extends AmcmcModElements.ModElement {
	@ObjectHolder("amcmc:alphariumingot")
	public static final Item block = null;

	public AlphariumingotItem(AmcmcModElements instance) {
		super(instance, 3);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("alphariumingot");
		}
