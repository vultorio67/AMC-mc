...
public class TungstenBlockBlock extends AmcmcModElements.ModElement {
	@ObjectHolder("amcmc:tungsten_block")
	public static final Block block = null;

	public TungstenBlockBlock(AmcmcModElements instance) {
		super(instance, 67);
	}
