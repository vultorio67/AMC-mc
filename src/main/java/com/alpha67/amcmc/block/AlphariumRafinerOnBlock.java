...
public class AlphariumRafinerOnBlock extends AmcmcModElements.ModElement {
	@ObjectHolder("amcmc:alpharium_rafiner_on")
	public static final Block block = null;
	@ObjectHolder("amcmc:alpharium_rafiner_on")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public AlphariumRafinerOnBlock(AmcmcModElements instance) {
		super(instance, 72);
