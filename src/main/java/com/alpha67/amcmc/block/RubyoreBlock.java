...
public class RubyoreBlock extends AmcmcModElements.ModElement {
	@ObjectHolder("amcmc:rubyore")
	public static final Block block = null;

	public RubyoreBlock(AmcmcModElements instance) {
		super(instance, 9);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("amcmc:rubyore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("amcmc:rubyore"), configuredFeature);
		}
	}
