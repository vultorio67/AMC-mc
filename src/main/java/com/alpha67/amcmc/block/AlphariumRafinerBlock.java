...
package com.alpha67.amcmc.block;
...
import com.alpha67.amcmc.procedures.PcrocedureAlphariumrfinerProcedure;
import com.alpha67.amcmc.procedures.GAlphariumRafinerBlockAddeduinbtProcedure;
import com.alpha67.amcmc.procedures.FusionMachineProcedureTickProcedure;
import com.alpha67.amcmc.itemgroup.AlphatabItemGroup;
import com.alpha67.amcmc.gui.GuiAlphariumRafinerGui;
import com.alpha67.amcmc.AmcmcModElements;

@AmcmcModElements.ModElement.Tag
public class AlphariumRafinerBlock extends AmcmcModElements.ModElement {
	@ObjectHolder("amcmc:alpharium_rafiner")
	public static final Block block = null;
	@ObjectHolder("amcmc:alpharium_rafiner")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public AlphariumRafinerBlock(AmcmcModElements instance) {
		super(instance, 21);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("alpharium_rafiner"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public void animateTick(BlockState blockstate, World world, BlockPos pos, Random random) {
			...
			FusionMachineProcedureTickProcedure.executeProcedure(Collections.EMPTY_MAP);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("alpharium_rafiner");
		}
