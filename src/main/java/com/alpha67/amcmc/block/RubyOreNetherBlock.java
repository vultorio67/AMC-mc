...
public class RubyOreNetherBlock extends AmcmcModElements.ModElement {
	@ObjectHolder("amcmc:ruby_ore_nether")
	public static final Block block = null;

	public RubyOreNetherBlock(AmcmcModElements instance) {
		super(instance, 10);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ruby_ore_nether");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("amcmc:ruby_ore_nether_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("amcmc:ruby_ore_nether"), configuredFeature);
		}
	}
