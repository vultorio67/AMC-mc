...
public class TungsteneoreBlock extends AmcmcModElements.ModElement {
	@ObjectHolder("amcmc:tungsteneore")
	public static final Block block = null;

	public TungsteneoreBlock(AmcmcModElements instance) {
		super(instance, 8);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("amcmc:tungsteneore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("amcmc:tungsteneore"), configuredFeature);
		}
	}
