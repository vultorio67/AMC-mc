...
public class FusionMachineBlock extends AmcmcModElements.ModElement {
	@ObjectHolder("amcmc:fusion_machine")
	public static final Block block = null;
	@ObjectHolder("amcmc:fusion_machine")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public FusionMachineBlock(AmcmcModElements instance) {
		super(instance, 63);
