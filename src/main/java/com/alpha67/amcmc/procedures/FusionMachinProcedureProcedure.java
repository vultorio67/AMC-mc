...
import com.alpha67.amcmc.item.RefinedRubyItem;
import com.alpha67.amcmc.item.ProtectionShardItem;
import com.alpha67.amcmc.item.MetalRubyIngotItem;
import com.alpha67.amcmc.block.TungstenBlockBlock;
import com.alpha67.amcmc.block.RubyBlockBlock;
import com.alpha67.amcmc.AmcmcMod;

public class FusionMachinProcedureProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				AmcmcMod.LOGGER.warn("Failed to load dependency world for procedure FusionMachinProcedure!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				AmcmcMod.LOGGER.warn("Failed to load dependency x for procedure FusionMachinProcedure!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				AmcmcMod.LOGGER.warn("Failed to load dependency y for procedure FusionMachinProcedure!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				AmcmcMod.LOGGER.warn("Failed to load dependency z for procedure FusionMachinProcedure!");
			return;
		}
		...
		if (((new Object() {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == RubyBlockBlock.block.asItem() && (new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
				TileEntity _ent = world.getTileEntity(pos);
				if (_ent != null) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (2))).getItem() == TungstenBlockBlock.block.asItem() && (new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
				TileEntity _ent = world.getTileEntity(pos);
				if (_ent != null) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (2))).getItem() == RubyBlockBlock.block.asItem() && (new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
				TileEntity _ent = world.getTileEntity(pos);
				if (_ent != null) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == TungstenBlockBlock.block.asItem() && (new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
				TileEntity _ent = world.getTileEntity(pos);
				if (_ent != null) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (3))).getItem() == ProtectionShardItem.block && new Object() {
			public int getAmount(IWorld world, BlockPos pos, int sltid) {
				AtomicInteger _retval = new AtomicInteger(0);
				TileEntity _ent = world.getTileEntity(pos);
				if (_ent != null) {
			...
			if (!world.isRemote()) {
				...
				BlockState _bs = world.getBlockState(_bp);
				if (_tileEntity != null)
					_tileEntity.getTileData().putDouble("timerGui", 0);
				if (world instanceof World)
					((World) world).notifyBlockUpdate(_bp, _bs, _bs, 3);
			}
		}
		if (new Object() {
			...
			if (new Object() {
				...
				if (new Object() {
					...
					System.out.println("ok" + (new Object() {
						public double getValue(IWorld world, BlockPos pos, String tag) {
							TileEntity tileEntity = world.getTileEntity(pos);
							if (tileEntity != null)
								return tileEntity.getTileData().getDouble(tag);
			...
			if (new Object() {
				...
				if (new Object() {
					...
					}
					{
						...
						if (_ent != null) {
							final int _sltid = (int) (3);
							final ItemStack _setstack = new ItemStack(ProtectionShardItem.block);
							_setstack.setCount((int) (new Object() {
								public int getAmount(IWorld world, BlockPos pos, int sltid) {
									AtomicInteger _retval = new AtomicInteger(0);
									TileEntity _ent = world.getTileEntity(pos);
