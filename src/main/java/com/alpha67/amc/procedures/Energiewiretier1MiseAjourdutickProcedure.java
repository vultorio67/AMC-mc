...
import com.alpha67.amc.block.Energiewiretier1Block;
import com.alpha67.amc.block.Energiewiretier14Block;
import com.alpha67.amc.block.Energiewiretier13Block;
import com.alpha67.amc.block.Energiewiretier12Block;
import com.alpha67.amc.AmcMod;

public class Energiewiretier1MiseAjourdutickProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				AmcMod.LOGGER.warn("Failed to load dependency world for procedure Energiewiretier1MiseAjourdutick!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				AmcMod.LOGGER.warn("Failed to load dependency x for procedure Energiewiretier1MiseAjourdutick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				AmcMod.LOGGER.warn("Failed to load dependency y for procedure Energiewiretier1MiseAjourdutick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				AmcMod.LOGGER.warn("Failed to load dependency z for procedure Energiewiretier1MiseAjourdutick!");
			return;
		}
		...
		if (nbblockconnecter > 0) {
			if ((BlockTags.getCollection().getTagByID(new ResourceLocation("forge:basicwiretag"))
					...
					|| BlockTags.getCollection().getTagByID(new ResourceLocation("forge:basicwiretag"))
							.contains((world.getBlockState(new BlockPos(x - 1, y, z))).getBlock()))
					&& nbblockconnecter == 1 && !((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Energiewiretier12Block.block)) {
				world.setBlockState(new BlockPos(x, y, z), Energiewiretier12Block.block.getDefaultState(), 3);
			}
			if ((BlockTags.getCollection().getTagByID(new ResourceLocation("forge:basicwiretag"))
					.contains((world.getBlockState(new BlockPos(x, y, z + 1))).getBlock())
					|| BlockTags.getCollection().getTagByID(new ResourceLocation("forge:basicwiretag"))
							.contains((world.getBlockState(new BlockPos(x, y, z - 1))).getBlock()))
					&& nbblockconnecter == 1 && !((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Energiewiretier1Block.block)) {
				world.setBlockState(new BlockPos(x, y, z), Energiewiretier1Block.block.getDefaultState(), 3);
			}
			if ((BlockTags.getCollection().getTagByID(new ResourceLocation("forge:basicwiretag"))
					.contains((world.getBlockState(new BlockPos(x, y + 1, z))).getBlock())
					|| BlockTags.getCollection().getTagByID(new ResourceLocation("forge:basicwiretag"))
							.contains((world.getBlockState(new BlockPos(x, y - 1, z))).getBlock()))
					&& !((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Energiewiretier14Block.block)) {
				world.setBlockState(new BlockPos(x, y, z), Energiewiretier14Block.block.getDefaultState(), 3);
			}
			if (BlockTags.getCollection().getTagByID(new ResourceLocation("forge:basicwiretag"))
					.contains((world.getBlockState(new BlockPos(x + 1, y, z))).getBlock())
					&& BlockTags.getCollection().getTagByID(new ResourceLocation("forge:basicwiretag"))
							.contains((world.getBlockState(new BlockPos(x - 1, y, z))).getBlock())
					&& nbblockconnecter == 2 && !((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Energiewiretier12Block.block)) {
				world.setBlockState(new BlockPos(x, y, z), Energiewiretier12Block.block.getDefaultState(), 3);
			}
			if (BlockTags.getCollection().getTagByID(new ResourceLocation("forge:basicwiretag"))
					.contains((world.getBlockState(new BlockPos(x, y, z + 1))).getBlock())
					&& BlockTags.getCollection().getTagByID(new ResourceLocation("forge:basicwiretag"))
							.contains((world.getBlockState(new BlockPos(x, y, z - 1))).getBlock())
					&& nbblockconnecter == 2 && !((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Energiewiretier1Block.block)) {
				world.setBlockState(new BlockPos(x, y, z), Energiewiretier1Block.block.getDefaultState(), 3);
			}
			if (!(BlockTags.getCollection().getTagByID(new ResourceLocation("forge:basicwiretag"))
					.contains((world.getBlockState(new BlockPos(x, y + 1, z))).getBlock())
					...
					&& !((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Energiewiretier13Block.block)) {
				world.setBlockState(new BlockPos(x, y, z), Energiewiretier13Block.block.getDefaultState(), 3);
			}
			if ((BlockTags.getCollection().getTagByID(new ResourceLocation("forge:basicwiretag"))
					.contains((world.getBlockState(new BlockPos(x + 1, y, z))).getBlock())
					&& BlockTags.getCollection().getTagByID(new ResourceLocation("forge:basicwiretag"))
					...
					|| BlockTags.getCollection().getTagByID(new ResourceLocation("forge:basicwiretag"))
							...
							&& BlockTags.getCollection().getTagByID(new ResourceLocation("forge:basicwiretag"))
									.contains((world.getBlockState(new BlockPos(x, y, z - 1))).getBlock()))
					&& nbblockconnecter == 2 && !((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Energiewiretier13Block.block)) {
				world.setBlockState(new BlockPos(x, y, z), Energiewiretier13Block.block.getDefaultState(), 3);
			}
				...
				if (nbblockconnecter == 1) {
					if (!(new Object() {
						...
						if (new Object() {
							...
							}.extractEnergySimulate(world, new BlockPos(x, y, z), (int) 200));
							down = (new Object() {
