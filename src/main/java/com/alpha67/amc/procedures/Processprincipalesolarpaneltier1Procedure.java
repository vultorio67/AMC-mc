...
public class Processprincipalesolarpaneltier1Procedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				AmcMod.LOGGER.warn("Failed to load dependency world for procedure Processprincipalesolarpaneltier1!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				AmcMod.LOGGER.warn("Failed to load dependency x for procedure Processprincipalesolarpaneltier1!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				AmcMod.LOGGER.warn("Failed to load dependency y for procedure Processprincipalesolarpaneltier1!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				AmcMod.LOGGER.warn("Failed to load dependency z for procedure Processprincipalesolarpaneltier1!");
			return;
		}
		...
		}.getValue(world, new BlockPos(x, y, z), "energieproduite") + 1)) {
			if (world.canBlockSeeSky(new BlockPos(x, y + 1, z)) && world.getWorldInfo().getDayTime() >= 0
					&& world.getWorldInfo().getDayTime() <= 12000) {
				if (world.getWorldInfo().getDayTime() <= 5000) {
					if (!world.isRemote()) {
						BlockPos _bp = new BlockPos(x, y, z);
						TileEntity _tileEntity = world.getTileEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
						if (_tileEntity != null)
							_tileEntity.getTileData().putDouble("pourcentage rendement", (new Object() {
								public double getValue(IWorld world, BlockPos pos, String tag) {
									TileEntity tileEntity = world.getTileEntity(pos);
									if (tileEntity != null)
										return tileEntity.getTileData().getDouble(tag);
							...
							}.getValue(world, new BlockPos(x, y, z), "pourcentage rendement") + 0.00015));
					...
					if (!world.isRemote()) {
						...
						BlockState _bs = world.getBlockState(_bp);
						if (_tileEntity != null)
							_tileEntity.getTileData().putDouble("energieproduite", (15 * (new Object() {
								public double getValue(IWorld world, BlockPos pos, String tag) {
									TileEntity tileEntity = world.getTileEntity(pos);
									if (tileEntity != null)
										return tileEntity.getTileData().getDouble(tag);
							...
							}.getValue(world, new BlockPos(x, y, z), "pourcentage rendement"))));
						if (world instanceof World)
							((World) world).notifyBlockUpdate(_bp, _bs, _bs, 3);
					}
				}
				if (world.getWorldInfo().getDayTime() >= 7000) {
					if (!world.isRemote()) {
						BlockPos _bp = new BlockPos(x, y, z);
						TileEntity _tileEntity = world.getTileEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
						if (_tileEntity != null)
							_tileEntity.getTileData().putDouble("pourcentage rendement2", ((new Object() {
								public double getValue(IWorld world, BlockPos pos, String tag) {
									TileEntity tileEntity = world.getTileEntity(pos);
									if (tileEntity != null)
										return tileEntity.getTileData().getDouble(tag);
							...
							}.getValue(world, new BlockPos(x, y, z), "pourcentage rendement2")) - 0.00015));
						if (world instanceof World)
							((World) world).notifyBlockUpdate(_bp, _bs, _bs, 3);
					}
					if (!world.isRemote()) {
						...
						if (_tileEntity != null)
							...
							}.getValue(world, new BlockPos(x, y, z), "pourcentage rendement2"))));
						if (world instanceof World)
							((World) world).notifyBlockUpdate(_bp, _bs, _bs, 3);
					}
				}
				if (world.getWorldInfo().getDayTime() < 7000 && world.getWorldInfo().getDayTime() > 5000) {
					if (!world.isRemote()) {
						BlockPos _bp = new BlockPos(x, y, z);
						TileEntity _tileEntity = world.getTileEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
						if (_tileEntity != null)
							_tileEntity.getTileData().putDouble("energieproduite", 15);
						if (world instanceof World)
							((World) world).notifyBlockUpdate(_bp, _bs, _bs, 3);
					}
				}
				{
					...
					}.getValue(world, new BlockPos(x, y, z), "energieproduite"));
					if (_ent != null)
						_ent.getCapability(CapabilityEnergy.ENERGY, null).ifPresent(capability -> capability.receiveEnergy(_amount, false));
				}
			}
			if (world.getWorldInfo().getDayTime() > 12000 && world.getWorldInfo().getDayTime() < 23000) {
				if (!world.isRemote()) {
					BlockPos _bp = new BlockPos(x, y, z);
					TileEntity _tileEntity = world.getTileEntity(_bp);
					BlockState _bs = world.getBlockState(_bp);
		...
		if (Direction.SOUTH == (new Object() {
			...
			if (!BlockTags.getCollection().getTagByID(new ResourceLocation("forge:cannotrecevenergie"))
				...
				}.extractEnergySimulate(world, new BlockPos(x, y, z), (int) 500));
				arriere = (new Object() {
