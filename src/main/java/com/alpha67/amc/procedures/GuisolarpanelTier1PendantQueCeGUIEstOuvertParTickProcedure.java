...
public class GuisolarpanelTier1PendantQueCeGUIEstOuvertParTickProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				AmcMod.LOGGER.warn("Failed to load dependency world for procedure GuisolarpanelTier1PendantQueCeGUIEstOuvertParTick!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				AmcMod.LOGGER.warn("Failed to load dependency entity for procedure GuisolarpanelTier1PendantQueCeGUIEstOuvertParTick!");
			return;
		}
