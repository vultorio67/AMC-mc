...
public class GuisolarpanelTier1GuiWindow extends ContainerScreen<GuisolarpanelTier1Gui.GuiContainerMod> {
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("amc:textures/solar.png"));
		this.blit(ms, this.guiLeft + 0, this.guiTop + -36, 0, 0, 256, 256, 256, 256);
