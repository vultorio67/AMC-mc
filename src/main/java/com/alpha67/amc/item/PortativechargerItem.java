...
import com.alpha67.amc.gui.PortaivechargerguiGuiWindow;
import com.alpha67.amc.gui.PortaivechargerguiGui;
import com.alpha67.amc.AmcModElements;

@AmcModElements.ModElement.Tag
public class PortativechargerItem extends AmcModElements.ModElement {
	@ObjectHolder("amc:portativecharger")
	public static final Item block = null;

	public PortativechargerItem(AmcModElements instance) {
		super(instance, 277);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof PortaivechargerguiGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(AlphatabItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON));
			setRegistryName("portativecharger");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Portative Charger");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new PortaivechargerguiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
