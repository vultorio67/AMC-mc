...
public class RubyArmorItem extends AmcModElements.ModElement {
	@ObjectHolder("amc:ruby_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("amc:ruby_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("amc:ruby_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("amc:ruby_armor_boots")
	public static final Item boots = null;

	public RubyArmorItem(AmcModElements instance) {
		super(instance, 54);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AlphatabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "amc:textures/models/armor/ruby__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
