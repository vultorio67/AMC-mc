...
public class TungsteneoreBlock extends AmcModElements.ModElement {
	@ObjectHolder("amc:tungsteneore")
	public static final Block block = null;

	public TungsteneoreBlock(AmcModElements instance) {
		super(instance, 8);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("amc:tungsteneore_match"), () -> CustomRuleTest.codec);
