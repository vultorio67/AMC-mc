...
public class Energiewiretier3Block extends AmcModElements.ModElement {
	@ObjectHolder("amc:energiewiretier_3")
	public static final Block block = null;
	@ObjectHolder("amc:energiewiretier_3")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public Energiewiretier3Block(AmcModElements instance) {
		super(instance, 237);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("energiewiretier_3"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("energiewiretier_3");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("energiewiretier_3");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Energie wire tier 3");
		}
