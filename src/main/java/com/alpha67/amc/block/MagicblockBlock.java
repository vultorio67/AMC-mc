...
public class MagicblockBlock extends AmcModElements.ModElement {
	@ObjectHolder("amc:magicblock")
	public static final Block block = null;

	public MagicblockBlock(AmcModElements instance) {
		super(instance, 149);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.GLASS).sound(SoundType.GLASS).hardnessAndResistance(1f, 17f).setLightLevel(s -> 0));
