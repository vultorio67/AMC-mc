...
public class BasicWireBlock extends AmcModElements.ModElement {
	@ObjectHolder("amc:basic_wire")
	public static final Block block = null;
	@ObjectHolder("amc:basic_wire")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public BasicWireBlock(AmcModElements instance) {
		super(instance, 158);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("basic_wire"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("basic_wire");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Basic Wire");
		}
