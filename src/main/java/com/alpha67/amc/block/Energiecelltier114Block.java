...
public class Energiecelltier114Block extends AmcModElements.ModElement {
	@ObjectHolder("amc:energiecelltier_114")
	public static final Block block = null;
	@ObjectHolder("amc:energiecelltier_114")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public Energiecelltier114Block(AmcModElements instance) {
		super(instance, 262);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("energiecelltier_114"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("energiecelltier_114");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("energiecelltier_114");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Energie cell tier 1");
		}
		...
		private final EnergyStorage energyStorage = new EnergyStorage(10000, 500, 500, 7644) {
			@Override
