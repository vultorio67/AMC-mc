...
public class RubyoreBlock extends AmcModElements.ModElement {
	@ObjectHolder("amc:rubyore")
	public static final Block block = null;

	public RubyoreBlock(AmcModElements instance) {
		super(instance, 9);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("amc:rubyore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("amc:rubyore"), configuredFeature);
		}
	}
