...
public class RubyOreNetherBlock extends AmcModElements.ModElement {
	@ObjectHolder("amc:ruby_ore_nether")
	public static final Block block = null;
	public RubyOreNetherBlock(AmcModElements instance) {
		super(instance, 10);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("amc:ruby_ore_nether_match"), () -> CustomRuleTest.codec);
