...
import com.alpha67.amc.procedures.CoalgeneratorMiseAJourDuTickProcedure;
import com.alpha67.amc.itemgroup.AlphatabItemGroup;
import com.alpha67.amc.gui.BasiccoalgeneratorGui;
import com.alpha67.amc.AmcModElements;

@AmcModElements.ModElement.Tag
public class CoalgeneratorBlock extends AmcModElements.ModElement {
	@ObjectHolder("amc:coalgenerator")
	public static final Block block = null;
	@ObjectHolder("amc:coalgenerator")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public CoalgeneratorBlock(AmcModElements instance) {
		super(instance, 267);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("coalgenerator"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Can produce 10Fe/t"));
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			CoalgeneratorMiseAJourDuTickProcedure.executeProcedure(Stream
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Basic coal generator");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new BasiccoalgeneratorGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("coalgenerator");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new BasiccoalgeneratorGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
