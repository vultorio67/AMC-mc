...
public class Energiecelltier15Block extends AmcModElements.ModElement {
	@ObjectHolder("amc:energiecelltier_15")
	public static final Block block = null;
	@ObjectHolder("amc:energiecelltier_15")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public Energiecelltier15Block(AmcModElements instance) {
		super(instance, 253);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("energiecelltier_15"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("energiecelltier_15");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("energiecelltier_15");
		}
		...
		private final EnergyStorage energyStorage = new EnergyStorage(10000, 500, 500, 2352) {
			@Override
