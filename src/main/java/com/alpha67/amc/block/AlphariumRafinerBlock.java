...
public class AlphariumRafinerBlock extends AmcModElements.ModElement {
	@ObjectHolder("amc:alpharium_rafiner")
	public static final Block block = null;
	@ObjectHolder("amc:alpharium_rafiner")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public AlphariumRafinerBlock(AmcModElements instance) {
		super(instance, 21);
