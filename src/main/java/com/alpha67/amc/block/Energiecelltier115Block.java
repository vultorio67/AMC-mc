...
public class Energiecelltier115Block extends AmcModElements.ModElement {
	@ObjectHolder("amc:energiecelltier_115")
	public static final Block block = null;
	@ObjectHolder("amc:energiecelltier_115")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public Energiecelltier115Block(AmcModElements instance) {
		super(instance, 263);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("energiecelltier_115"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("energiecelltier_115");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("energiecelltier_115");
		}
		...
		private final EnergyStorage energyStorage = new EnergyStorage(10000, 500, 500, 8232) {
			@Override
